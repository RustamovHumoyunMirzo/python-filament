...
1. `filament._native` is a small pybind11 extension linked to a pinned prebuilt Filament SDK. It
   owns native pointers and contains only operations where crossing the C++ boundary is necessary.
